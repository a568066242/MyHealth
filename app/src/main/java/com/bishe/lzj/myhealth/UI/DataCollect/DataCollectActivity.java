...
import com.bishe.lzj.myhealth.UI.BaseActivity;
...
//        new ChooseBluetoothDialog(DataCollectActivity.this, new ChooseBluetoothDialog.ChoosedCallbackListener() {
//            @Override
...
//        findViewById(R.id.click_bp).setOnClickListener(this);
//        findViewById(R.id.click_bs).setOnClickListener(this);
////        findViewById(R.id.click_hr).setOnClickListener(this);
//        findViewById(R.id.click_os).setOnClickListener(this);
//        findViewById(R.id.click_pulse).setOnClickListener(this);
//    }
//
//    @Override
//    protected void onDestroy() {
//        super.onDestroy();
//        BluetoothUtil.unRegisterBroadcast();
//    }
//
//
//    @Override
...
//        TextView tv = (TextView) findViewById(tv_RID[current_fragment]);
